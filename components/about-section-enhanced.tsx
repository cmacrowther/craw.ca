          ...
          <div className="space-y-8 animate-slide-left">
            <div data-animate className="prose prose-lg dark:prose-invert max-w-none space-y-8">
              ...
              <div className="relative">
                ...
                <div className="pl-8">
                  <p className="font-body text-lg leading-relaxed text-foreground">
                    ...
                    <span className="font-medium text-purple-600 dark:text-purple-400"> accessible</span>, and guided by <span className="font-medium text-blue-600 dark:text-red-400">core UX principles</span>.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="pl-8">
                  <p className="font-body text-lg leading-relaxed text-foreground">
                    By day, I work as a Java developer on 
                    ...
                    By night, I set my focus on bleeding-edge tech, exploring modern frameworks, experimenting with ideas, and bringing new concepts to life.
                  </p>
                </div>
              </div>
