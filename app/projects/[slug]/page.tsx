      ...
      <main className="relative overflow-hidden">
        ...
        <section className="relative px-4 pb-16 pt-8 sm:px-6 lg:px-8 lg:pb-24 lg:pt-16">
          <div className="container mx-auto max-w-7xl">
            <Link
              href="/#projects"
              className="mb-8 inline-flex items-center gap-2 rounded-full border border-border/60 bg-background/70 px-4 py-2 font-body text-sm font-medium text-muted-foreground backdrop-blur-xl transition-colors hover:text-foreground dark:border-white/10 dark:bg-white/5"
            >
