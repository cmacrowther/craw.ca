...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "referee",
    title: "REFEREE",
    shortDescription: "On-device AI upscaling service that lets developers ship low-bitrate streams while users with NVIDIA RTX or AMD Radeon hardware see 4K.",
    longDescription:
    ...
    buildFocus: "A Rust-powered, hardware-accelerated local streaming pipeline that sits between web players and origin servers, enhancing quality on-device using NVIDIA RTX or AMD Radeon without any server-side changes.",
    ...
    video: "/referee.webm",
    technologies: ["AI Upscaling Pipeline", "Rust", "Tauri", "Vite", "NVEncC", "VCEEncC", "NVIDIA RTX", "AMD Radeon", "HLS"],
  ...
  },
  {
    ...
    slug: "referee-demo",
    title: "REFEREE Demo",
    shortDescription: "Live demo and docs for REFEREE — an on-device AI upscaler that upgrades low-bitrate streams to 4K using NVIDIA RTX or AMD Radeon hardware.",
    longDescription:
    ...
    experienceGoal: "Let developers and users see the quality gap REFEREE closes — from low-bitrate source to 4K output — in a single drag of a slider.",
    video: "/referee_demo.webm",
    technologies: ["AI Upscaling Pipeline", "Rust", "Tauri", "Vite", "NVEncC", "VCEEncC", "NVIDIA RTX", "AMD Radeon"],
    githubUrl: "https://github.com/cmacrowther/referee",
    liveUrl: "https://referee.craw.ca/",
